    ...
    <div>
        <div class="bg-cover bg-center bg-[url('../../public/images/varosunk/nagymaros_banner-scaled.jpeg')] h-96 relative">
            <div class="w-9/12 bg-slate-900 bg-opacity-70 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-10">
                <p class="text-3xl md:text-[40px] text-white text-center">
            ...
            <div class="grid grid-cols-7 gap-4 h-screen content-center">
                <a href="{{ route('latnivalok') }}"
                    class="col-start-2 col-end-4 hover:shadow-[9px__9px_0px_rgb(34,197,94)] text-white text-center bg-slate-900 ease-out hover:translate-y-1 transition-all p-6 my-4">
                    <div>
                        <p>
                            Turizmus
                        </p>
                ...
                <a href="{{ route('koszonto') }}"
                    class="col-end-7 col-span-2 hover:shadow-[9px__9px_0px_rgb(34,197,94)] text-white text-center bg-slate-900 ease-out hover:translate-y-1 transition-all p-6 my-4">
                    <div>
                        <p>
                            Önkormányzat
                        </p>
