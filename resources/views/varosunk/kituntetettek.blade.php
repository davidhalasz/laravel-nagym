    ...
    <div class="max-w-4xl mx-auto font-extrabold">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        Páneurópai Unió Elnöke, Európai Parlament Tagja
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        Nagymaros Nagyközség polgármestere
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
            ...
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        DJ0 Baden- Württemberg iskolafejlesztés segítése, németországi nyelvi gyakorlat**
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        A Dunakanyar Fúvósegyüttes évtizedeken át való magas színvonalú vezetése és zenepedagógusi
                        munka.
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        Férfikórus 90 éves múlt. Kiemelkedő művészeti munka, zenei élet fejlesztése.
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        kiemelkedő tudományos tevékenységéért és Nagymaros fejlesztési
                        koncepciójának kidolgozásában való részvételért
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        kiemelkedő sporteredményeikért, Nagymaros hírnevének öregbítéséért
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
            ...
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        egyetemi tanár, Habsburg Otto Baráti Kör megalapítója
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        egykori önkormányzati képviselő Föld Kiadó Biz. Elnök
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
            ...
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        Az iskolai tornaterem széles társadalmi összefogással megvalósuló, példaértékű felújítását
                        összefogó fáradhatatlan munkája elismeréseként (Hód Kft ügyvez.)
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
            ...
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        Nagymaros hírnevének öregbítéséért, város közéletében kifejtett aktív közreműködésükért, a sok
                        nemes célt elérő felajánlásokat gyűjtő akcióikért
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
            ...
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        Nyugdíjas Klubban nyújtott kiemelkedő munkájáért
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        Árvízi védekezésben való kiemelkedő részvételükért
                    </p>
                </div>
            </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
                ...
                <div class="col-span-2 px-4 pb-4">
                    <p>
                        a Nagymaros FC és az ifjúság támogatásáért kifejtett önzetlen tevékenységéért
                    </p>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-2 bg-slate-900 text-white rounded-xl">
